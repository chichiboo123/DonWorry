...
import heroImg from '@/assets/little-prince-hero.png';
...
export default function SetupPage({ onComplete }: Props) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 theme-gradient">
      <div className="max-w-md w-full space-y-8 text-center">
        <div className="space-y-4">
          <img src={heroImg} alt="어린왕자" className="w-48 h-48 mx-auto object-contain animate-float" />
          <div className="flex items-center justify-center gap-2">
            <img src={starIcon} alt="" className="w-8 h-8" />
            <h1 className="text-3xl font-bold text-foreground">돈 워리</h1>
          </div>
